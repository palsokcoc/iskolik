...
import RaporEnCokBasvuruYapilanIlanlar from "./rapor/pages/EnCokBasvuruYapilanIlanlar";
...
export default () => (
  <Switch>
    ...
    <RouteWithSidebar exact path={Routes.RaporEnCokBasvuruYapilanIlanlar.path} component={RaporEnCokBasvuruYapilanIlanlar} />
