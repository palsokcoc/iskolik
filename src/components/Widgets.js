  ...
  return (
    <Card border="light" className="text-center p-0 mb-4">
      ...
      <Card.Body className="pb-5">
        <Card.Img src={Profile1} alt="Badi Ekrem" className="user-avatar large-avatar rounded-circle mx-auto mt-n7 mb-4" />
        <Card.Title>Badi Ekrem</Card.Title>
        <Card.Subtitle className="fw-normal">Beden Eğitimi Öğretmeni</Card.Subtitle>
        <Card.Text className="text-gray mb-4">İstanbul, Türkiye</Card.Text>
      </Card.Body>
    </Card>
  );
};
